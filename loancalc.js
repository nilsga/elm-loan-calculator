				...
				return _elm_lang$core$Native_Utils.update(
					config,
					{
						value: _elm_lang$core$Maybe$Just(
							A2(_elm_lang$core$Debug$log, 'str', str))
					});
			})(_p3));
};
...
var _nilsga$elm_test$LoanCalculations$termInterest = function (_p0) {
	var _p1 = _p0;
	return _p1.interestRate / _elm_lang$core$Basics$toFloat(_p1.terms);
};
var _nilsga$elm_test$LoanCalculations$termAmount = function (loan) {
	var _p2 = loan;
	var amount = _p2.amount;
	var duration = _p2.duration;
	var terms = _p2.terms;
	var termFee = _p2.termFee;
	var interestPerTerm = _nilsga$elm_test$LoanCalculations$termInterest(loan);
	return ((_elm_lang$core$Basics$toFloat(amount) * interestPerTerm) / (1 - Math.pow(
		1 + interestPerTerm,
		_elm_lang$core$Basics$toFloat((0 - duration) * terms)))) + _elm_lang$core$Basics$toFloat(termFee);
};
var _nilsga$elm_test$LoanCalculations$termBalance = F2(
	function (loan, term) {
		var _p3 = loan;
		var amount = _p3.amount;
		var interestPerTerm = _nilsga$elm_test$LoanCalculations$termInterest(loan);
		return (_elm_lang$core$Basics$toFloat(amount) * Math.pow(1 + interestPerTerm, term)) - ((_nilsga$elm_test$LoanCalculations$termAmount(loan) / interestPerTerm) * (Math.pow(1 + interestPerTerm, term) - 1));
	});
var _nilsga$elm_test$LoanCalculations$term = F2(
	function (loan, term) {
		var amount = _nilsga$elm_test$LoanCalculations$termAmount(loan);
		var balance = A2(_nilsga$elm_test$LoanCalculations$termBalance, loan, term);
		var previousTermBalance = A2(_nilsga$elm_test$LoanCalculations$termBalance, loan, term - 1);
		var principal = previousTermBalance - balance;
		var interest = amount - principal;
		return {
			amount: _elm_lang$core$Basics$round(amount),
			principal: _elm_lang$core$Basics$round(principal),
			interest: _elm_lang$core$Basics$round(interest),
			balance: _elm_lang$core$Basics$round(balance)
		};
	});
var _nilsga$elm_test$LoanCalculations$terms = function (loan) {
	var _p4 = loan;
	var terms = _p4.terms;
	var duration = _p4.duration;
	return A2(
		_elm_lang$core$List$map,
		function (n) {
			return A2(
				_nilsga$elm_test$LoanCalculations$term,
				loan,
				_elm_lang$core$Basics$toFloat(n));
		},
		A2(_elm_lang$core$List$range, 0, terms * duration));
};
var _nilsga$elm_test$LoanCalculations$LoanDetails = F6(
	function (a, b, c, d, e, f) {
		return {amount: a, interestRate: b, terms: c, duration: d, initialFee: e, termFee: f};
	});
var _nilsga$elm_test$LoanCalculations$Term = F4(
	function (a, b, c, d) {
		return {amount: a, principal: b, interest: c, balance: d};
	});

var _nilsga$elm_test$Main$model = {
	loanDetails: {amount: 2000000, interestRate: 3, terms: 12, duration: 20, termFee: 0, initialFee: 0},
	calculatedTermAmount: 0,
	mdl: _debois$elm_mdl$Material$model
};
var _nilsga$elm_test$Main$white = _debois$elm_mdl$Material_Color$text(_debois$elm_mdl$Material_Color$white);
var _nilsga$elm_test$Main$Model = F3(
	function (a, b, c) {
		return {loanDetails: a, calculatedTermAmount: b, mdl: c};
	});
var _nilsga$elm_test$Main$Batch = function (a) {
	return {ctor: 'Batch', _0: a};
};
var _nilsga$elm_test$Main$Mdl = function (a) {
	return {ctor: 'Mdl', _0: a};
};
var _nilsga$elm_test$Main$update = F2(
	function (msg, oldModel) {
		var oldLoanDetails = oldModel.loanDetails;
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'LoanAmount':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						oldModel,
						{
							loanDetails: _elm_lang$core$Native_Utils.update(
								oldLoanDetails,
								{
									amount: A2(
			...
			case 'Recalculate':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						oldModel,
						{
							calculatedTermAmount: _nilsga$elm_test$LoanCalculations$termAmount(oldLoanDetails)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Mdl':
				return A3(_debois$elm_mdl$Material$update, _nilsga$elm_test$Main$Mdl, _p0._0, oldModel);
			default:
				var _p1 = A3(
					_elm_lang$core$List$foldr,
					F2(
						function (msg, _p2) {
							var _p3 = _p2;
							var _p4 = A2(_nilsga$elm_test$Main$update, msg, _p3._0);
							var newModel = _p4._0;
							var newFx = _p4._1;
							return {
								ctor: '_Tuple2',
					...
					{
						ctor: '_Tuple2',
						_0: _nilsga$elm_test$Main$model,
						_1: {ctor: '[]'}
					},
					A2(_elm_lang$core$Debug$log, 'listOfMsg', _p0._0));
				var finalModel = _p1._0;
				var listOfFx = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: finalModel,
...
var _nilsga$elm_test$Main$Recalculate = {ctor: 'Recalculate'};
var _nilsga$elm_test$Main$textField = F4(
	function (name, index, mdl, msg) {
		return A5(
			_debois$elm_mdl$Material_Textfield$render,
			_nilsga$elm_test$Main$Mdl,
			{
				ctor: '::',
				_0: index,
				_1: {ctor: '[]'}
			...
			mdl,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _debois$elm_mdl$Material_Options$dispatch(_nilsga$elm_test$Main$Batch),
						_1: {
							ctor: '::',
							_0: _debois$elm_mdl$Material_Options$onInput(msg),
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onBlur(_nilsga$elm_test$Main$Recalculate),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _nilsga$elm_test$Main$LoanDuration = function (a) {
	return {ctor: 'LoanDuration', _0: a};
};
var _nilsga$elm_test$Main$LoanInterestRate = function (a) {
	return {ctor: 'LoanInterestRate', _0: a};
};
var _nilsga$elm_test$Main$LoanAmount = function (a) {
	return {ctor: 'LoanAmount', _0: a};
};
var _nilsga$elm_test$Main$view = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _nilsga$elm_test$Main$white,
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Lånedetaljer'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A4(_nilsga$elm_test$Main$textField, 'Lånbebeløp', 0, model.mdl, _nilsga$elm_test$Main$LoanAmount),
						_1: {
							ctor: '::',
							_0: A4(_nilsga$elm_test$Main$textField, 'Nedbetalingstid', 1, model.mdl, _nilsga$elm_test$Main$LoanDuration),
							_1: {
								ctor: '::',
								_0: A4(_nilsga$elm_test$Main$textField, 'Rente', 2, model.mdl, _nilsga$elm_test$Main$LoanInterestRate),
								_1: {ctor: '[]'}
							}
						}
					}),
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: A2(_debois$elm_mdl$Material_Options$css, 'padding', '8px 16px 8px 16px'),
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Color$background(
													A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$LightBlue, _debois$elm_mdl$Material_Color$S400)),
							...
							_0: A2(
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(model.calculatedTermAmount)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _nilsga$elm_test$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _nilsga$elm_test$Main$model, _1: _elm_lang$core$Platform_Cmd$none},
		view: _nilsga$elm_test$Main$view,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none),
		update: _nilsga$elm_test$Main$update
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _nilsga$elm_test$Main$main !== 'undefined') {
    _nilsga$elm_test$Main$main(Elm['Main'], 'Main', undefined);
}
